/* =========================================================
   ...
   `pagina` referencia la página exacta de ese PDF (assets/docs/cartilla-vendedor.pdf)
   para poder mostrar la imagen real de la ficha dentro de la app.
   ========================================================= */

const CARTILLA_VENDEDOR = [
  // ---- Breakers ----
  {nombre:"Breaker tipo enchufable NEMA — sistema americano", cat:"Breakers", pagina:2,
  ...
  {nombre:"Breaker tipo riel DIN — ANSI, sistema europeo", cat:"Breakers", pagina:3,
  ...
  {nombre:"Breaker de protección residual tipo riel", cat:"Breakers", pagina:4,
    normas:"NTC 2116, IEC 60898-1. Certificado RETIE N°1873-2365 (QCERT).",
  ...
  {nombre:"Breaker totalizador de caja moldeada", cat:"Breakers", pagina:5,
  ...
  // ---- Tableros ----
  {nombre:"Tablero enchufable de incrustar (barra partida)", cat:"Tableros", pagina:6,
  ...
  {nombre:"Tablero 2 y 4 circuitos sobreponer tipo enchufable", cat:"Tableros", pagina:7,
  ...
  {nombre:"Tablero tipo riel", cat:"Tableros", pagina:8,
  ...
  {nombre:"Caja 1 y 2 circuitos sobreponer, sistema riel DIN", cat:"Tableros", pagina:9,
  ...
  {nombre:"Caja 3 y 4 circuitos sobreponer, sistema riel DIN", cat:"Tableros", pagina:10,
    normas:"NTC 2050. Certificado RETIE N°1744 (QCERT).",
    caracteristicas:"Icc de 6000A (6KA); Ue 120V/240V; In 75A. Sistema DIN. Instalación de sobreponer, grado de protección IP20 en zonas de salpique de agua.",
    dondeUsarlo:"Protección de circuitos en redes internas de locales y burbujas comerciales: iluminación, motores, aire acondicionado o energía solar.",
    tenPresente:"Compacto, diseño moderno y de fácil instalación."},

  {nombre:"Tableros industriales de baja tensión (enchufable trifásico)", cat:"Tableros", pagina:11,
    normas:"NTC 3475, NTC 2050, IEC 61439-1/3. Certificado RETIE N°0458 (QCERT).",
  ...
  // ---- Cajas y protección ----
  {nombre:"Cajas de protección de riel herméticas", cat:"Cajas y protección", pagina:12,
    normas:"NTC 3475, NTC 2050, IEC 61439-1/3. Certificado RETIE N°0458 (QCERT).",
  ...
  {nombre:"Cajas herméticas IP65", cat:"Cajas y protección", pagina:35,
  ...
  {nombre:"Cajas herméticas IP65 — tapa transparente", cat:"Cajas y protección", pagina:36,
    normas:"NTC 979. Certificado RETIE N°1744 (QCERT).",
  ...
  {nombre:"Caja para canaletas de sobreponer", cat:"Cajas y protección", pagina:37,
    normas:"NTC 979. Certificado RETIE N°1744 (QCERT).",
  ...
  {nombre:"Cajas conduit estándar", cat:"Cajas y protección", pagina:33,
    normas:"NTC 979. Certificado RETIE N°1744 (QCERT).",
  ...
  {nombre:"Cajas reforzadas para vaciado IP44", cat:"Cajas y protección", pagina:34,
  ...
  {nombre:"Tapas para cajas conduit", cat:"Cajas y protección", pagina:32,
  ...
  // ---- Suichería ----
  {nombre:"Línea de suichería NOVA", cat:"Suichería", pagina:13,
  ...
  {nombre:"Línea de suichería SPAZIO Natural", cat:"Suichería", pagina:14,
    normas:"NTC 1337, NTC 1650, IEC 60669-1, IEC 60884-4. Certificado RETIE N°0455–N°0457 (QCERT).",
  ...
  {nombre:"Línea de suichería SPAZIO Negro Mate", cat:"Suichería", pagina:15,
    normas:"NTC 1337, NTC 1650, IEC 60669-1, IEC 60884-4. Certificado RETIE N°0455–N°0457 (QCERT).",
  ...
  {nombre:"Línea de suichería ULTRA Natural", cat:"Suichería", pagina:16,
    normas:"NTC 1337, NTC 1650, IEC 60669-1, IEC 60884-4. Certificado RETIE N°0455–N°0457 (QCERT).",
  ...
  {nombre:"Línea de suichería ULTRA Plus", cat:"Suichería", pagina:17,
    normas:"NTC 1337, NTC 1650, IEC 60669-1, IEC 60884-4. Certificado RETIE N°0455–N°0457 (QCERT).",
  ...
  {nombre:"Línea de suichería ULTRA Negra sin marco", cat:"Suichería", pagina:18,
    normas:"NTC 1337, NTC 1650, IEC 60669-1, IEC 60884-4. Certificado RETIE N°0455–N°0457 (QCERT).",
  ...
  {nombre:"Detector fotoeléctrico de humo dual 9V-DC/120V-AC", cat:"Sensores y detectores", pagina:25,
    normas:"—",
  ...
  // ---- Plafones ----
  {nombre:"Plafones / rosetas", cat:"Plafones", pagina:26,
  ...
  {nombre:"Plafón premium rosca E-27", cat:"Plafones", pagina:27,
    normas:"—",
  ...
  // ---- Tomacorrientes ----
  {nombre:"Tomacorrientes tipo NEMA — sistema americano", cat:"Tomacorrientes", pagina:28,
  ...
  {nombre:"Tomacorrientes (línea industrial)", cat:"Tomacorrientes", pagina:29,
    normas:"NTC 2206. Certificado RETIE N°04478-03017 (CIDET).",
    caracteristicas:"—"},

  // ---- Conectores y accesorios ----
  {nombre:"Conector + unión conduit libres de halógenos", cat:"Conectores y accesorios", pagina:30,
    normas:"NTC 979. Certificado RETIE N°1744 (QCERT).",
  ...
  {nombre:"Conector contratuerca libres de halógenos", cat:"Conectores y accesorios", pagina:31,
    normas:"NTC 979. Certificado RETIE N°1744 (QCERT).",
  ...
  {nombre:"Conectores terminales bimetálicos", cat:"Conectores y accesorios", pagina:39,
  ...
  {nombre:"Varilla copperweld para puesta a tierra con conector tipo pestaña", cat:"Conectores y accesorios", pagina:40,
    normas:"NTC 2206. Certificado RETIE N°04478-03017 (CIDET).",
  ...
  {nombre:"Cintas aislantes de PVC", cat:"Conectores y accesorios", pagina:38,
